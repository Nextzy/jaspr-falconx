...
class PlaceSchema extends Schema {
  ...
  factory PlaceSchema.eventVenue({
    ...
    List<Map<String, String>>? placeEvents,
  }) {
    return PlaceSchema(
      name: name,
      description: description,
  ...
  final String? maximumAttendeeCapacity;
  final SchemaDataType<PlaceSchema>? containedInPlace;
  final SchemaDataType<PlaceSchema>? containsPlace;
  final List<Map<String, String>>? placeEvents;
  final String? isAccessibleForFree;
...
typedef PlaceSchemaData = PlaceSchema;
